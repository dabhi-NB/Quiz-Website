  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="" width=100 height=100 alt="devloper-image" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">name</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">mobile_no</h4>
		<h4 style="font-family:'typo' ">email id</h4>
		<h4 style="font-family:'typo' ">address</h4></div></div>
		</p>
      </div>
